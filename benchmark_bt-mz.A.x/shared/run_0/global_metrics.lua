_report = {
  metrics = {
    ...
    compilation_flags = "bt-mz.A.x: GNU 9.3.0 -mtune=generic -march=x86-64 -g -O3 -fopenmp -fintrinsic-modules-path /usr/lib/gcc/x86_64-linux-gnu/9/finclude -fpre-include=/usr/include/finclude/math-vector-fortran.h \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 55.45,
    speedup_if_fp_vect = 1.0403,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0024057738573,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0024057738573,
    nb_loops_80_if_FP_only = 6,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 13,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 3,
    speedup_if_fully_vectorised = 1.7128,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.0078697576864,
    speedup_if_clean = 1.039,
    profiled_time = 61.97,
    array_access_efficiency = 89.33462375484,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2884,
    nb_threads = 1,
    application_time = 61.97,
    compilation_options = "bt-mz.A.x:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 53.76,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 34.362365 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 33.315072 seconds.",
  },
  colors = {
