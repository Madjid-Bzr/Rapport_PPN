_report = {
  metrics = {
    ...
    compilation_flags = "nbody0: GNU 9.3.0 -mtune=generic -march=x86-64 -g -Ofast -funroll-loops -finline-functions -ftree-vectorize -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 92.12,
    speedup_if_fp_vect = 1,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0038144950813,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0038144950813,
    ...
    speedup_if_fully_vectorised = 1.0507,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.044192678309,
    speedup_if_clean = 1.0062,
    profiled_time = 8,
    array_access_efficiency = 79.195121025874,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0317,
    nb_threads = 1,
    application_time = 8,
    compilation_options = "nbody0:  -march=(target) is missing. \n",
    innerloops_time = 91.24,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.3696 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 7.2992 seconds.",
  },
  colors = {
