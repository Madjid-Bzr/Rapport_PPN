_report = {
  metrics = {
    ...
    compilation_flags = "nbody.g1: GNU 10.3.0 -march=tigerlake -mtune=generic -g -O2 -funroll-loops -finline-functions -fno-omit-frame-pointer -ftree-vectorize -fopt-info-all=nbody.gcc.optrpt -fopenmp -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.99,
    speedup_if_fp_vect = 1.414,
    ...
    speedup_if_fully_vectorised = 12.5926,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 12.548325320294,
    speedup_if_clean = 1.081,
    profiled_time = 68.65,
    array_access_efficiency = 71.213571863767,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2112,
    nb_threads = 1,
    application_time = 68.65,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 68.643135 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 68.629405 seconds.",
  },
  colors = {
