_report = {
  metrics = {
    ...
    compilation_flags = "queens: GNU 9.3.0 -mtune=generic -march=x86-64 -g -std=c99 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    ...
    speedup_if_fully_vectorised = 1.8043,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 7.33,
    array_access_efficiency = 75.966350586066,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1,
    nb_threads = 1,
    application_time = 7.33,
    compilation_options = "queens:  -O2, -O3 or -Ofast is missing. -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 50.62,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.710446 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.710446 seconds.",
  },
  colors = {
