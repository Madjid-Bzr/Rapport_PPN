_report = {
  metrics = {
    ...
    compilation_flags = "nbody.g: GNU 10.3.0 -mavx2 -mtune=generic -march=x86-64 -g -fopt-info-all=nbody.gcc.optrpt -fopenmp -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 37.91,
    speedup_if_fp_vect = 1.1223,
    ...
    speedup_if_fully_vectorised = 1.5457,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0646,
    profiled_time = 66.76,
    array_access_efficiency = 83.332234238987,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2112,
    nb_threads = 1,
    application_time = 66.76,
    compilation_options = "nbody.g:  -O2, -O3 or -Ofast is missing. -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 37.9,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 25.308716 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 25.30204 seconds.",
  },
  colors = {
