  ...
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4    | P5   | P6   | P7\n---------------------------------------------------------------\nuops   | 3.50 | 5.00 | 9.67 | 9.67 | 20.00 | 5.00 | 3.50 | 9.67\ncycles | 3.50 | 5.00 | 9.67 | 9.67 | 20.00 | 5.00 | 3.50 | 9.67\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
        ...
        },
        {
          ...
          txt = "Assuming all data fit into the L1 cache, each call to the function takes 20.00 cycles. At this rate:\n - 0% of peak load performance is reached (0.40 out of 64.00 bytes loaded per cycle (GB/s @ 1GHz))\n - 14% of peak store performance is reached (4.60 out of 32.00 bytes stored per cycle (GB/s @ 1GHz))\n",
        },
        {
