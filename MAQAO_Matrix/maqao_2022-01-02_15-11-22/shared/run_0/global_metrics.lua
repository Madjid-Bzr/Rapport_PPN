_report = {
  metrics = {
    ...
    compilation_flags = "matrix: GNU 9.3.0 -mtune=generic -march=x86-64 -g -std=c99 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    ...
    speedup_if_fully_vectorised = 5.4158,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 0.36,
    array_access_efficiency = 66.789343634718,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1,
    nb_threads = 1,
    application_time = 0.36,
    compilation_options = "matrix:  -O2, -O3 or -Ofast is missing. -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 95.78,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.344808 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: profiling results are not statistically significant (profiled time corresponds to 71 samples) and should not be used<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.344808 seconds.",
  },
  colors = {
