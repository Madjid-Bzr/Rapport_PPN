_report = {
  metrics = {
    ...
    compilation_flags = "nbody_op: GNU 9.3.0 -mtune=generic -march=x86-64 -g -Ofast -funroll-loops -finline-functions -ftree-vectorize -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 86.44,
    speedup_if_fp_vect = 1.6669,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0050251256281,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0050251256281,
    ...
    speedup_if_fully_vectorised = 1.8131,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0477787091366,
    speedup_if_clean = 1.004,
    profiled_time = 5.02,
    array_access_efficiency = 99.897347687286,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0501,
    nb_threads = 1,
    application_time = 5.02,
    compilation_options = "nbody_op:  -march=(target) is missing. \n",
    innerloops_time = 85.74,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.339288 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.304148 seconds.",
  },
  colors = {
