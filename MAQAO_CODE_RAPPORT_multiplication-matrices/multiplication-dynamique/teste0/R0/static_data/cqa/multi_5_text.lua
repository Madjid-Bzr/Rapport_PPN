_cqa_text_report = {
  paths = {
    ...
    },
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 1.75 | 1.75 | 3.00 | 3.00 | 2.00 | 1.75 | 1.75 | 2.00\ncycles | 1.75 | 1.75 | 3.00 | 3.00 | 2.00 | 1.75 | 1.75 | 2.00\n\nCycles executing div or sqrt instructions: NA\nLongest recurrence chain latency (RecMII): 0.00\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 3.50\nDispatch  : 3.00\nData deps.: 0.00\nOverall L1: 3.50\n",
  ...
  AVG = {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 2.00 | 2.00 | 3.25 | 3.25 | 2.50 | 2.00 | 2.00 | 2.50\ncycles | 2.00 | 2.00 | 3.25 | 3.25 | 2.50 | 2.00 | 2.00 | 2.50\n\nCycles executing div or sqrt instructions: NA\nLongest recurrence chain latency (RecMII): 0.00\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 3.75\nDispatch  : 3.25\nData deps.: 0.00\nOverall L1: 3.75\n",
