_report = {
  metrics = {
    ...
    compilation_flags = "nbody_Version_SSE_Packed: GNU 9.3.0 -mtune=generic -march=x86-64 -g -Ofast -funroll-loops -finline-functions -ftree-vectorize -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 98.64,
    speedup_if_fp_vect = 1.1665,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0019036168721,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0019036168721,
    ...
    speedup_if_fully_vectorised = 3.5743,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0064871240417,
    speedup_if_clean = 1.1512,
    profiled_time = 8.04,
    array_access_efficiency = 80,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3634,
    nb_threads = 1,
    application_time = 8.04,
    compilation_options = "nbody_Version_SSE_Packed:  -march=(target) is missing. \n",
    innerloops_time = 98.64,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.930656 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 7.930656 seconds.",
  },
  colors = {
