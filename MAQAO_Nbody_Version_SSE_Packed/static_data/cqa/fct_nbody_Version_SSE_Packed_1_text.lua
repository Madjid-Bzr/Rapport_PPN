_cqa_text_report = {
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6    | P7   | P8   | P9\n-----------------------------------------------------------------------------\nuops   | 3.75 | 3.75 | 5.00 | 5.00 | 7.50 | 3.50 | 10.00 | 8.00 | 8.00 | 7.50\ncycles | 3.75 | 3.75 | 5.00 | 5.00 | 7.50 | 3.50 | 10.00 | 8.00 | 8.00 | 7.50\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
      ...
      gain = {
        {
          ...
          title = "Vectorization",
          txt = "Your function is not vectorized.\nOnly 8% of vector register length is used (average across all SSE/AVX instructions).\nBy vectorizing your function, you can lower the cost of an iteration from 11.00 to 0.73 cycles (15.04x speedup).",
        },
        {
  ...
  common = {
    header = {
      "The function is defined in:\n - /usr/include/x86_64-linux-gnu/bits/stdio2.h:107\n - /home/anism/Bureau/Test Nbody Version Scalaire /nbody_Version_SSE_Packed.c:41-43,66,198-205,228-229,242-243,250,258-308\n\n",
