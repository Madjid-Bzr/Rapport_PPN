  ...
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 1.00 | 5.00 | 5.00 | 5.00 | 5.00 | 1.00 | 1.00 | 5.00\ncycles | 1.00 | 5.00 | 5.00 | 5.00 | 5.00 | 1.00 | 1.00 | 5.00\n\nCycles executing div or sqrt instructions: NA\nLongest recurrence chain latency (RecMII): 1.00\n",
        },
        {
        ...
        },
        {
          ...
          txt = "Assuming all data fit into the L1 cache, each iteration of the binary loop takes 5.75 cycles. At this rate:\n - 43% of peak load performance is reached (27.83 out of 64.00 bytes loaded per cycle (GB/s @ 1GHz))\n - 43% of peak store performance is reached (13.91 out of 32.00 bytes stored per cycle (GB/s @ 1GHz))\n",
        },
        {
