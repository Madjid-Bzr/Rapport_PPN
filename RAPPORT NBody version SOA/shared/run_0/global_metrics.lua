_report = {
  metrics = {
    ...
    compilation_flags = "SOA: GNU 9.3.0 -mtune=generic -march=x86-64 -g -Ofast -funroll-loops -finline-functions -ftree-vectorize -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 66.92,
    speedup_if_fp_vect = 1.691,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 6.9045541288275,
    ...
    speedup_if_fully_vectorised = 2.0324,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 2.0134831792761,
    speedup_if_clean = 1.0016,
    profiled_time = 2.8,
    array_access_efficiency = 78.452783595607,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0196,
    nb_threads = 9,
    application_time = 2.8,
    compilation_options = "SOA:  -march=(target) is missing. \n",
    innerloops_time = 66.52,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.87376 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: statistical accuracy of profiling results is average (profiled time corresponds to 744 samples)<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.86256 seconds.",
  },
  colors = {
