_report = {
  metrics = {
    ...
    compilation_flags = "bt-mz.W.x: GNU 9.3.0 -mtune=generic -march=x86-64 -g -O3 -fopenmp -fintrinsic-modules-path /usr/lib/gcc/x86_64-linux-gnu/9/finclude -fpre-include=/usr/include/finclude/math-vector-fortran.h \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 52.25,
    speedup_if_fp_vect = 1.0369,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0117361392149,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0117361392149,
    nb_loops_80_if_FP_only = 8,
    GFlops = "Not Implemented Yet",
    speedup_if_L1 = "Not Available",
    GBs = "Not Implemented Yet",
    nb_loops_80_if_fully_vect = 14,
    nb_loops_80_if_perfect_openmp = "Not Available",
    nb_loops_80_if_clean = 6,
    speedup_if_fully_vectorised = 1.6477,
    nb_loops_80_if_fp_vect = 6,
    flow_complexity = 1.0123464084944,
    speedup_if_clean = 1.0381,
    profiled_time = 5.34,
    array_access_efficiency = 88.715494988323,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2793,
    nb_threads = 1,
    application_time = 5.34,
    compilation_options = "bt-mz.W.x:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 48.87,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 2.79015 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 2.609658 seconds.",
  },
  colors = {
