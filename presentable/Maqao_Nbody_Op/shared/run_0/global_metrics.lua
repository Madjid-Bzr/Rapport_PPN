_report = {
  metrics = {
    ...
    compilation_flags = "nbody0: GNU 9.3.0 -march=broadwell -g -Ofast -funroll-loops -finline-functions -ftree-vectorize -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    ...
    speedup_if_fully_vectorised = 1.0709,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0616450408322,
    speedup_if_clean = 1.0101,
    profiled_time = 2.44,
    array_access_efficiency = 83.333333333333,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0518,
    nb_threads = 1,
    application_time = 2.44,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 2.434632 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: statistical accuracy of profiling results is average (profiled time corresponds to 475 samples)<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 2.39364 seconds.",
  },
  colors = {
