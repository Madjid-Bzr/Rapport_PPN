_report = {
  metrics = {
    ...
    compilation_flags = "nbody1: GNU 9.3.0 -mtune=generic -march=x86-64 -g -Ofast -funroll-loops -finline-functions -ftree-vectorize -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 67.38,
    speedup_if_fp_vect = 1.4287,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 5.0306871918704,
    ...
    speedup_if_fully_vectorised = 1.5763,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.553667988764,
    speedup_if_clean = 1.005,
    profiled_time = 12.25,
    array_access_efficiency = 79.166666666667,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0303,
    nb_threads = 5,
    application_time = 12.25,
    compilation_options = "nbody1:  -march=(target) is missing. \n",
    innerloops_time = 65.83,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 8.25405 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: statistical accuracy of profiling results is average (profiled time corresponds to 518 samples)<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 8.064175 seconds.",
  },
  colors = {
