_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 12.6066,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 12.606582589972,
    speedup_if_clean = 1.081,
    profiled_time = 5.87,
    array_access_efficiency = 71.212121212121,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2111,
    nb_threads = 1,
    application_time = 5.87,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.87 seconds.",
