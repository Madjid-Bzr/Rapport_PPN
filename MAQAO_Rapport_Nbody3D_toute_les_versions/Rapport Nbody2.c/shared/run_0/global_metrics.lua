_report = {
  metrics = {
    ...
    compilation_flags = "nbody.g2: GNU 10.3.0 -mavx2 -march=tigerlake -mtune=generic -g -Ofast -funroll-loops -finline-functions -fno-omit-frame-pointer -ftree-vectorize -fopt-info-all=nbody.gcc.optrpt -fopenmp -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.96,
    speedup_if_fp_vect = 1.0005,
    ...
    speedup_if_fully_vectorised = 1.0006,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 11.19552 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 11.18544 seconds.",
  },
  colors = {
