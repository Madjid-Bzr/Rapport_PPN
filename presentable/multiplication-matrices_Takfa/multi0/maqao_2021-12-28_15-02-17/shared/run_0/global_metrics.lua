_report = {
  metrics = {
    ...
    compilation_flags = "multi: GNU 7.5.0 -mtune=generic -march=x86-64 -g -std=c99 -fstack-protector-strong \n",
    ...
    speedup_if_fully_vectorised = 7.6088,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 1.15,
    array_access_efficiency = 66.70349907919,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1,
    nb_threads = 1,
    application_time = 1.15,
    compilation_options = "multi:  -O2, -O3 or -Ofast is missing. -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 99.55,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.144825 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: statistical accuracy of profiling results is average (profiled time corresponds to 225 samples)<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.144825 seconds.",
  },
  colors = {
