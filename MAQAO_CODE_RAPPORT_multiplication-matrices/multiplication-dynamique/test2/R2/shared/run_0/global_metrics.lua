_report = {
  metrics = {
    ...
    flow_complexity = 1,
    speedup_if_clean = 1.0347,
    profiled_time = 0.41,
    array_access_efficiency = 87.406868451688,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1,
    nb_threads = 1,
    application_time = 0.41,
    compilation_options = "OK",
    innerloops_time = 85.9,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.373223 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: profiling results are not statistically significant (profiled time corresponds to 78 samples) and should not be used<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.35219 seconds.",
  },
  colors = {
