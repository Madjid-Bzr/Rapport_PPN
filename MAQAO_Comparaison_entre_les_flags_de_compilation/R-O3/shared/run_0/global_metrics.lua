_report = {
  metrics = {
    ...
    compilation_flags = "nbody.g2: GNU 10.3.0 -march=tigerlake -mtune=generic -g -O3 -funroll-loops -finline-functions -fno-omit-frame-pointer -ftree-vectorize -fopt-info-all=nbody.gcc.optrpt -fopenmp -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 100,
    speedup_if_fp_vect = 1.4712,
    ...
    speedup_if_fully_vectorised = 11.94,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1132,
    profiled_time = 72.38,
    array_access_efficiency = 100,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3112,
    nb_threads = 1,
    application_time = 72.38,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 72.38 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 72.372762 seconds.",
  },
  colors = {
