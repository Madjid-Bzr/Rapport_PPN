_cqa_text_report = {
  paths = {
    {
      ...
      expert = {
        ...
        },
        {
          ...
          txt = "Assuming all data fit into the L1 cache, each iteration of the binary loop takes 7.75 cycles. At this rate:\n - 10% of peak load performance is reached (6.71 out of 64.00 bytes loaded per cycle (GB/s @ 1GHz))\n - 17% of peak store performance is reached (5.68 out of 32.00 bytes stored per cycle (GB/s @ 1GHz))\n",
        },
        {
  ...
  AVG = {
      ...
      expert = {
        ...
        {
          title = "Cycles and memory resources usage",
          txt = "Assuming all data fit into the L1 cache, each iteration of the binary loop takes 7.00 cycles. At this rate:\n - 10% of peak load performance is reached (6.87 out of 64.00 bytes loaded per cycle (GB/s @ 1GHz))\n - 18% of peak store performance is reached (6.04 out of 32.00 bytes stored per cycle (GB/s @ 1GHz))\n",
        },
      },
      header = {
        "0% of peak computational performance is used (0.00 out of 4.00 FLOP per cycle (GFLOPS @ 1GHz))",
