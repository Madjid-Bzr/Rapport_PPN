_report = {
  metrics = {
    ...
    compilation_flags = "nbody.g: GNU 10.3.0 -mtune=generic -march=x86-64 -g -fopt-info-all=nbody.gcc.optrpt -fopenmp -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 92.38,
    speedup_if_fp_vect = 1.2095,
    ...
    speedup_if_fully_vectorised = 6.9424,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1928,
    profiled_time = 25.64,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 23.686232 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 23.686232 seconds.",
  },
  colors = {
