_report = {
  metrics = {
    ...
    compilation_flags = "nbody_Version_SSE_Scalar: GNU 9.3.0 -mtune=generic -march=x86-64 -g -Ofast -funroll-loops -finline-functions -ftree-vectorize -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 81.25,
    speedup_if_fp_vect = 1.0996,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 7.8477579670953,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0013016921999,
    ...
    speedup_if_fully_vectorised = 3.3534,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0028440029145,
    speedup_if_clean = 1.0916,
    profiled_time = 3.9,
    array_access_efficiency = 83.345741820739,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.5546,
    nb_threads = 9,
    application_time = 3.9,
    compilation_options = "nbody_Version_SSE_Scalar:  -march=(target) is missing. \n",
    innerloops_time = 80.92,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.16875 seconds.",
    ...
    profiled_time = "Application profiling duration in seconds<br><b>Too short run</b>: statistical accuracy of profiling results is average (profiled time corresponds to 917 samples)<br><b>Workaround</b>: Rerun with a longer workload and/or use sampling-rate=high/highest in lprof_params",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.15588 seconds.",
  },
  colors = {
