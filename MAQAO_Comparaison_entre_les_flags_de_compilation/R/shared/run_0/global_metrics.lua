_report = {
  metrics = {
    ...
    compilation_flags = "nbody.g: GNU 10.3.0 -march=tigerlake -mtune=generic -g -funroll-loops -finline-functions -fno-omit-frame-pointer -ftree-vectorize -fopt-info-all=nbody.gcc.optrpt -fopenmp -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 90.71,
    speedup_if_fp_vect = 1.2049,
    ...
    speedup_if_fully_vectorised = 6.269,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1887,
    profiled_time = 304.29,
    array_access_efficiency = 83.333333333333,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.6897,
    nb_threads = 1,
    application_time = 304.29,
    compilation_options = "nbody.g:  -O2, -O3 or -Ofast is missing. \n",
    innerloops_time = 90.71,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 276.021459 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 276.021459 seconds.",
  },
  colors = {
